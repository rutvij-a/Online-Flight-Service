...
public class details extends JFrame 
{
	...
	{		
		...
		lblhrs.setBackground(Color.WHITE);
		...
		lblHr.setForeground(new Color(0, 0, 0));
		...
		lblHrs_3.setForeground(new Color(0, 0, 0));
		...
		lblHr_1.setForeground(new Color(0, 0, 0));
		...
		lblHr_2.setForeground(new Color(0, 0, 0));
		...
		lblHr_3.setForeground(new Color(0, 0, 0));
		...
		lblHrs_2.setForeground(new Color(0, 0, 0));
		...
		lblHrs_1.setForeground(new Color(0, 0, 0));
