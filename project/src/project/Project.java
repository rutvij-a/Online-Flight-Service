...
public class Project {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 631, 467);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		JLabel lblWelcomeToAirline = new JLabel("Welcome to Airline Service");
		lblWelcomeToAirline.setForeground(new Color(0, 0, 255));
		...
		JLabel lblPassangers = new JLabel("Passengers:");
		...
		btnSearchFlights.setBounds(229, 365, 144, 39);
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\rutvi\\OneDrive\\Desktop\\New folder (3)\\images (1).jpeg"));
		lblNewLabel.setBounds(0, -153, 615, 716);
